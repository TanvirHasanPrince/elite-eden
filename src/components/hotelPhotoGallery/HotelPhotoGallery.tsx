...
const HotelPhotoGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
  ...
  return (
    <div className="container mx-auto">
      <div className="grid md:grid-cols-2 lg:grid-cols-2 relative gap-5 px-3">
        <div className="h-[540px] relative rounded-2xl overflow-hidden">
          <div className="hidden md:flex lg:flex justify-center items-center w-full h-full">
            <Image
              src={photos[0].url}
          ...
          <div className=" md:flex lg:flex justify-center items-center w-full h-full">
            <Image
        ...
        <div className="md:hidden lg:hidden flex justify-between items-center">
        ...
        {showModal && (
          <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-90 z-55">
            <div className="h-[75vh] w-[320px] md:w-[700px] lg:w-[700px] relative">
              <Image
                src={photos[currentPhotoIndex].url}
                alt={`Room photo ${currentPhotoIndex + 1}`}
                width={150}
