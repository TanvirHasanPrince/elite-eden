    ...
    <div className="container mx-auto px-2 md:px-4 py10">
      <div className="grid md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-8 lg:col-span-9">
          ...
          <div className="md:hidden lg:hidden w-14 h-14 rounded-l-full overflow-hidden">
            <Image
              className="img scale-animation rounded-full"
              width={56}
              height={56}
          ...
          {/* Starting of user profile navigation panel */}
          ...
          {/* Ending of user profile navigation panel */}
